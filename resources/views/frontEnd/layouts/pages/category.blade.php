    ...
    <section class="homeproduct product-section">
        <div class="container">
            ...
            <div class="row">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseCat" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body cust_according_body">
                                            <ul>
                                                @foreach ($category->subcategories as $key => $childcat)
                                                    <li>
                                                        <a
                                                            href="{{ url('product/' . $childcat->slug) }}">{{ $childcat->subcategoryName }}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                                                            ...
                                                            <li class="subcategory-filter-list">
                                                                <label
                                                                    ...
                                                                    <input class="form-checkbox form-attribute"
                                                                        ...
                                                                        name="childcategory[]"
                                                                        value="{{ $childcategory->id }}" type="checkbox"
                ...
                <div class="col-sm-9">
                    <div class="product_slider category-product">
